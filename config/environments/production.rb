Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "keystorm_#{Rails.env}"
  ...
  config.x.audit = ActiveSupport::Logger.broadcast(Logger.new(config.keystorm['audit_file']))
  config.x.audit.log_level = :info
